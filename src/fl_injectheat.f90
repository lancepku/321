...
Zamc = 0.25*abs(cord(int(Z1100),nx/2,2)+cord(int(Z1100)+1,nx/2+1,2)+cord(int(Z1100)+&
1,nx/2,2)+cord(int(Z1100),nx/2+1,2))+ D_axial
Z600 = 1
do j=1,nz
...
!print *,Z1100
HL=0.25*abs(cord(int(Z600),nx/2,2)+cord(int(Z600)+1,nx/2+1,2)+cord(int(Z600)+1,&
nx/2,2)+cord(int(Z600),nx/2+1,2))+D_axial
